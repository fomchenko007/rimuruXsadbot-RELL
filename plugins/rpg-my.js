const daily = require('../plugins/rpg-daily.js');
const weekly = require('../plugins/rpg-weekly.js');
const monthly = require('../plugins/rpg-monthly.js');
const adventure = require('../plugins/rpg-adventure.js');
