...
let handler = async (m, { conn, text }) => {
  ...
  let betAmount = Math.floor(Math.random() * (10000 - 10000 + 1)) + 10000 
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          m.reply(`Anda dapat bertarung lagi setelah 1 jam`) 
        }, 60000) // https://github.com/SazumiVicky/MakeMeow-Games
      }, 20000)
    }, 20000) 
  }, 20000) 
}
