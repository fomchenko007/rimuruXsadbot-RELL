...
let handler = async (m, {
    ...
    await m.reply("wait"); // Replace "wait" with the appropriate variable or message
    try {
        ...
        await m.reply("eror"); // Replace "eror" with the appropriate variable or message
    }
};
handler.help = ["gptdemo"];
handler.tags = ["ai"];
handler.command = /^(gptdemo)$/i;
