...
const draw = async (options) => {
    ...
    const promises = Array.from({
        ...
        //ÐÑÐ»Ð¸ comp = true ÑÐ¾ Ð¿ÐµÑÐµÐ±Ð¸ÑÐ°ÑÑÑÑ Ð²ÑÐµ Ð¼Ð¾Ð´ÐµÐ»Ð¸
        ...
        do {
            await wait(3000);
            //ÐÐ¶Ð¸Ð´Ð°Ð½Ð¸Ðµ 3 ÑÐµÐºÑÐ½Ð´ Ð¿ÐµÑÐµÐ´ Ð¿Ð¾Ð²ÑÐ¾ÑÐ½Ð¾Ð¹ Ð¿ÑÐ¾Ð²ÐµÑÐºÐ¾Ð¹ ÑÑÐ°ÑÑÑÐ° 
